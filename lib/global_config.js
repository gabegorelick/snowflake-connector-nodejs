...
let xmlParserConfiguration = null;
...
/**
 * Return default configuration for XmlParser.
 *
 * @returns {object}
 */
exports.getXmlParserConfiguration = function ()
{
  if (xmlParserConfiguration === undefined || xmlParserConfiguration  === null) {
    return defaultXmlParserConfiguration;
  }
  return xmlParserConfiguration;
}

/**
 * Set custom xmlParser configuration or use default.
 ...
 * @param {object} value
 */
exports.setXmlParserConfiguration = function (xmlParamers)
{
  const resultConfig = {
    ignoreAttributes: xmlParamers && xmlParamers.ignoreAttributes !== undefined  && xmlParamers.ignoreAttributes !== null ? xmlParamers.ignoreAttributes : defaultXmlParserConfiguration.ignoreAttributes,
    attributeNamePrefix: xmlParamers && xmlParamers.attributeNamePrefix !== undefined  && xmlParamers.attributeNamePrefix !== null ? xmlParamers.attributeNamePrefix : defaultXmlParserConfiguration.attributeNamePrefix,
    attributesGroupName: xmlParamers && xmlParamers.attributesGroupName !== undefined  && xmlParamers.attributesGroupName !== null ? xmlParamers.attributesGroupName : defaultXmlParserConfiguration.attributesGroupName,
    alwaysCreateTextNode: xmlParamers && xmlParamers.alwaysCreateTextNode !== undefined  && xmlParamers.alwaysCreateTextNode !== null ? xmlParamers.alwaysCreateTextNode : defaultXmlParserConfiguration.alwaysCreateTextNode,
    }
  xmlParserConfiguration = resultConfig;
}
